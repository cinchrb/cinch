...
*** DONE Load the configuration from a hash                         :feature:
    ...
    :END:
*** DEV-BRANCH Modularize Cinch::IRC#connect
    :PROPERTIES:
    :Branch:   feature/modularized_irc_connect
    :END:
*** DEV-BRANCH Support justin tv
    :PROPERTIES:
    :Branch:   feature-support_jtv
    :END:
*** DEV-BRANCH Helpers should get defined on the specific Callback, not all. :bug:
    :PROPERTIES:
    :Branch: fix/helpers
    :END:
*** DEV-BRANCH Define helpers in Helpers module and include it in Bot
    :PROPERTIES:
    :Branch: improve/helpers
    :END:
*** DEV-BRANCH include Helpers in User and Channel (and maybe IRC, too) and use its helper methods
    :PROPERTIES:
    :Branch: improve/helpers
    :END:
*** DEV-BRANCH Allow unregistering handlers
    :PROPERTIES:
...
*** DEV-BRANCH Support malformed ircnet bans                    :improvement:
    :PROPERTIES:
    :Branch: improve/malformed_bans
    :END:
    Some (all?) bans on IRCnet are lacking the host of the banner
*** DEV-BRANCH Subclass Queue instead of monkeypatching it      :improvement:
    :PROPERTIES:
...
*** TODO Check documentation for wrong multiline docs (e.g. Message#reply)
